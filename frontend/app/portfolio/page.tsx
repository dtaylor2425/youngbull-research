    ...
    <main>
      ...
      <section className="page-hero container performance-portfolio-hero">
        <div className="eyebrow">
          REAL POSITIONS · PERFORMANCE ONLY
        </div>
        <h1>Young Bull Portfolio</h1>
        <p>
          Portfolio performance calculated from the latest available
          market data. Account value, position cost and dollar gains
          remain private.
        </p>
      </section>
      ...
      <section className="container performance-kpis">
        ...
        <article>
          ...
          <strong className="positive">
            {portfolio.summary.best_position?.ticker ?? "N/A"}
          </strong>
          <small>
            {portfolio.summary.best_position
              ? formatPct(
                  portfolio.summary.best_position.return_pct
                )
              : ""}
          </small>
        </article>
        ...
        <article>
          ...
          <strong className="negative">
            {portfolio.summary.worst_position?.ticker ?? "N/A"}
          </strong>
          <small>
            {portfolio.summary.worst_position
              ? formatPct(
                  portfolio.summary.worst_position.return_pct
                )
              : ""}
          </small>
        </article>
      ...
      <section className="container page-section">
        <div className="portfolio-page-heading">
          ...
          <small>
            Live coverage:{" "}
            {portfolio.summary.coverage_pct.toFixed(0)}%
          </small>
        </div>
        ...
        <p className="disclaimer">
          Returns use the latest market data available through the
          site&apos;s data provider and may differ from brokerage
          intraday P&amp;L. Current weights are recalculated from the
          latest available marks.
        </p>
      </section>
    </main>
  );
